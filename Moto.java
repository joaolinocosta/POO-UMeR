...
public class Moto extends Veiculo
{
    ...
    public Moto(String marca1,String modelo1,double pVelocidadeMedia, double pPrecoBase ,int pFactorDeFiabilidade,
    ...
    public Moto(Moto m)
    {
        super(m.getMarca(),m.getModelo(),m.getVelocidadeMedia(),m.getPrecoBase(),m.getFactorDeFiabilidade(),m.getCapacidade(),m.getHistoricoDeViagens());
