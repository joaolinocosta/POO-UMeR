...
public class CarroLigeiro extends Veiculo
{
    ...
    {
        super(cl.getId(),cl.getMarca(),cl.getModelo(),cl.getVelocidadeMedia(),cl.getPrecoBase(),cl.getFactorDeFiabilidade(),cl.getCapacidade(),cl.getHistoricoDeViagens(), cl.getFilaDeEspera());
